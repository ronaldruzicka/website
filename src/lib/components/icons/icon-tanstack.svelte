<script lang="ts">
	...
	const tanstack_a = `${instance_id}-a`;
	const tanstack_b = `${instance_id}-b`;
	const tanstack_c = `${instance_id}-c`;
	const tanstack_d = `${instance_id}-d`;
	const tanstack_e = `${instance_id}-e`;
	const tanstack_f = `${instance_id}-f`;
	const tanstack_g = `${instance_id}-g`;
	const tanstack_h = `${instance_id}-h`;
	const tanstack_i = `${instance_id}-i`;
	const tanstack_j = `${instance_id}-j`;
	const tanstack_k = `${instance_id}-k`;
	const tanstack_l = `${instance_id}-l`;
	const tanstack_m = `${instance_id}-m`;
	const tanstack_n = `${instance_id}-n`;
	const tanstack_o = `${instance_id}-o`;
	const tanstack_p = `${instance_id}-p`;
	const tanstack_q = `${instance_id}-q`;
	const tanstack_r = `${instance_id}-r`;
	const tanstack_s = `${instance_id}-s`;
	const tanstack_t = `${instance_id}-t`;
	const tanstack_u = `${instance_id}-u`;
	const tanstack_v = `${instance_id}-v`;
</script>
