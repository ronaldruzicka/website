...
export const EXPERIENCE_ENTRIES: ExperienceEntry[] = [
  ...
  },
  {
    ...
    stack: ['React', 'TypeScript', 'Styled Components', 'Framer Motion', 'Next.js'],
  },
  {
  ...
  },
  {
    ...
    stack: ['Nunjucks', 'Sass', 'JavaScript', 'React', 'Flow', 'Redux', 'Gulp', 'Webpack'],
  },
  {
    id: '41bcf6c8-d944-457d-8a07-c5fb52a4b0d1',
    date_range: 'Oct 2011 — Jan 2017',
    company: 'Dry Con / Pricewise (Bratislava), G2G Online (Netherlands), Mega (Prague)',
    location: '',
    job_title: 'Freelance',
    highlights: [
